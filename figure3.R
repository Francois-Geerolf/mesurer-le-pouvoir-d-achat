...
figure3 <- "https://ec.europa.eu/eurostat/api/dissemination/sdmx/2.1/data/NAMA_10_CO3_P3/A.PD15_EUR.CP08.FR+DE+IT+NL+ES" |> 
  rsdmx::readSDMX() |>
  as_tibble() |>
...
ggsave("figure3.pdf", width = 1.25*6, height = 1.25*3.375, dpi = 150)
